...
function Main(props) {
  ...
  //console.log("Main");
  //console.log(address); // 주소를 잘 받아왔으면 download/plot/파일이름 주소 이 주소에 들어가면 된다
      ...
      <Container>
        <Header>
          ...
          <Menu>
            <Ul>
              ...
              <Separator></Separator>
              <Link href="#Insert_Parameter">Insert_Parameter</Link>
              <Separator></Separator>
        ...
        <List className="list">
          <Three id="Insert_Parameter">
            <ThreeDiv>
              <Parameter>
                <CreateList setParamData={setParamData}></CreateList>
              </Parameter>
              <Submit
